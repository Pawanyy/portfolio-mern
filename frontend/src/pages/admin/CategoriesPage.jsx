...
export default function CategoriesPage() {
  ...
  useEffect(() => {
    const fetchRecords = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`${constant.API_URL}/category`, {
          headers: {
  ...
  const handleEdit = async (recordId, updatedData) => {
    ...
    try {
      const response = await axios.put(
        `${constant.API_URL}/category/${recordId}`,
        updatedData,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      await axios.delete(`${constant.API_URL}/category/${selectedRecord._id}`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${tokenDetails.authToken}`,
        },
